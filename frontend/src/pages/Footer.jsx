          ...
          <div className="border-t border-amber-500/30 pt-4">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-white text-sm">+91 9637319746
                </span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-white text-sm">+91 9766670916</span>
              </div>
            </div>
          </div>

          {/* Legal and Copyright */}
          <div className="border-t border-amber-500/30 pt-4 flex flex-col sm:flex-row items-center justify-between gap-4">
